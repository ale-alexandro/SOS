...
//allocate some heap memory to int array for kern usage
...
heap_t *create_heap(uint32_t placement_addr, uint32_t start,
                    uint32_t end, uint32_t max, uint8_t supervisor, uint8_t readonly)
{
